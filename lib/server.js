...
<body>
    ...
    <script>
        async function getPairingCode() {
            ...
            btn.disabled = true; btn.innerText = "⏳ GENERATING..."; status.innerText = "Connecting to server...";
            try {
                ...
                btn.disabled = false; btn.innerText = "GET PAIRING CODE"; status.innerText = "❌ Error: " + e.message;
            }
        }
        function copyCode() {
